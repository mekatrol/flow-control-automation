...
public sealed class FlowIlV2ContractFixtureTests
{
    ...
    {
        if (artifact.Length < EnvelopeLength || !artifact.AsSpan(0, 4).SequenceEqual("FIL2"u8) ||
            ReadUInt16(artifact, 4) != 2 || ReadUInt16(artifact, 6) != EnvelopeLength)
        {
        ...
        for (var index = 0; index < sectionCount; index++)
        {
            ...
            if ((id is 2 or 6 ? version is not (1 or 2) : version != 1) || offset != expectedOffset ||
