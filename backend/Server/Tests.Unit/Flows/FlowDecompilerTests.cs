...
public sealed class FlowDecompilerTests
{
    ...
    public void RejectsCorruptArtifactsBeforeReadingInstructions()
    {
        ...
        Assert.That(exception!.Diagnostic.Code, Is.EqualTo(FlowCompilerCode.InvalidDigest));
    }
    ...
    public void RejectsUnsupportedArtifactVersionsWithAStablePath()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(exception!.Diagnostic.Code, Is.EqualTo(FlowCompilerCode.UnsupportedVersion));
