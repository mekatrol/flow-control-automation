...
namespace Tests.Unit.Configuration.ControllerTemplates;
...
internal sealed class ControllerTemplateValidatorTests
{
    ...
    public void SetUp()
    {
        _validator = TestServices.CreateProvider()
            .GetRequiredService<IControllerTemplateValidator>();
    }
    ...
    public void ConstrainedFixture_ParsesAndValidatesAsTypedCapabilities()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            // constrained fixture parses and validates as typed capabilities.
            Assert.That(validated.PointTypes, Is.EquivalentTo([AutomationPointValueType.Digital]));
    ...
    public void Default_IsReadOnlyAndExhaustive()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            // default is read only and exhaustive.
            Assert.That(validated.PointTypes, Is.EquivalentTo(Enum.GetValues<AutomationPointValueType>()));
    ...
    public void UnsupportedCapabilityEnums_AreRejectedWithPaths(string capability)
    {
        ...
        {
            "pointTypes" => capabilities with { PointTypes = [(AutomationPointValueType)byte.MaxValue] },
    ...
    public void DuplicateCapabilities_AreRejected(string capability)
    {
        ...
        capabilities = capability switch
        {
            "pointTypes" => capabilities with { PointTypes = [AutomationPointValueType.Digital, AutomationPointValueType.Digital] },
