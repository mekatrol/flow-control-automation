...
internal partial class FlowValidator : IFlowValidator
{
    ...
    [
        ...
        FlowNodeKind.D2A, FlowNodeKind.OnDelay, FlowNodeKind.QualityGood, FlowNodeKind.RisingEdge, FlowNodeKind.Timer, FlowNodeKind.Xnor, FlowNodeKind.Xor, FlowNodeKind.Counter, FlowNodeKind.Clock,
    ];
