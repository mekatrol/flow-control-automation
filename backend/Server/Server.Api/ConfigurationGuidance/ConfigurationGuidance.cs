...
public static class ConfigurationGuidance
{
    private static readonly Dictionary<Type, Dictionary<string, string>> Help =
        new Dictionary<Type, Dictionary<string, string>>
        {
            ...
            [typeof(MappingReadOperation)] = H(("path", "Relative HTTP read path."), ("method", "Safe read method."), ("responseFormat", "Response decoding format: `json` or `text`. Text responses are exposed to the template as `response`."), ("template", "Template rendering an alias object from the decoded response."), ("topic", "MQTT state topic."), ("qos", "MQTT read QoS."), ("entityId", "Home Assistant entity identifier."), ("property", "Home Assistant state property."), ("pollMilliseconds", "Optional mapping polling interval.")),
            [typeof(MappingCommandOperation)] = H(("path", "Relative HTTP command path."), ("method", "Command method."), ("bodyFormat", "Template rendering mode: `json` or `text`."), ("contentType", "Optional HTTP media type compatible with bodyFormat; form-encoded bodies use text rendering."), ("template", "Template rendering the command body using format-specific value emission."), ("topic", "MQTT command topic."), ("qos", "MQTT command QoS."), ("retain", "Whether MQTT retains the command."), ("service", "Home Assistant service."), ("serviceData", "Home Assistant service payload.")),
