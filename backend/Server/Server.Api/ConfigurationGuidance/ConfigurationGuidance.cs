...
public static class ConfigurationGuidance
{
    private static readonly Dictionary<Type, Dictionary<string, string>> Help =
        new Dictionary<Type, Dictionary<string, string>>
        {
            ...
            [typeof(MappingReadOperation)] = H(("path", "Relative HTTP read path."), ("method", "Safe read method."), ("payloadFormat", "Payload decoding format: `json` or `text`. Text payloads are exposed to the template as `response`."), ("accept", "Optional HTTP Accept media type."), ("template", "Template rendering an alias object from the decoded payload."), ("topic", "MQTT state topic."), ("qos", "MQTT read QoS."), ("entityId", "Home Assistant entity identifier."), ("property", "Home Assistant state property."), ("pollMilliseconds", "Optional mapping polling interval.")),
            [typeof(MappingCommandOperation)] = H(("path", "Relative HTTP command path."), ("method", "Command method."), ("payloadFormat", "Template rendering mode: `json` or `text`."), ("contentType", "Optional HTTP media type compatible with payloadFormat; form-encoded bodies use text rendering."), ("template", "Template rendering the command body using format-specific value emission."), ("topic", "MQTT command topic."), ("qos", "MQTT command QoS."), ("retain", "Whether MQTT retains the command."), ("service", "Home Assistant service."), ("serviceData", "Home Assistant service payload.")),
