...
{
    Task ActivateFlowAsync(string executionInstanceId, string flowId, IReadOnlyList<VirtualPointDefinition> definitions, IReadOnlySet<string> writerKeys, CancellationToken cancellationToken);
