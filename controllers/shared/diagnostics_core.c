...
static const char EVENT_FORMAT[] =
...
{
    switch (severity) {
    case DIAGNOSTIC_DEBUG: return SEVERITY_DEBUG;
    case DIAGNOSTIC_INFO: return SEVERITY_INFO;
    case DIAGNOSTIC_WARNING: return SEVERITY_WARNING;
    case DIAGNOSTIC_ERROR: return SEVERITY_ERROR;
                            ...
                            uint64_t timestamp_ms, const char *message)
{
    ...
    return snprintf(output, output_size, EVENT_FORMAT,
                    timestamp_ms, get_diagnostic_severity_name(severity), component,
                                              ...
                                              const char *wifi_password)
{
    ...
    return snprintf(output, output_size, NETWORK_CONFIG_FORMAT,
                    wifi_enabled ? VALUE_ENABLED : VALUE_DISABLED,
                    credential_configured ? VALUE_REDACTED
