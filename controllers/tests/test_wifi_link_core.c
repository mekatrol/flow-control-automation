...
{
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_DRIVER_STARTED) ==
           NETWORK_EVENT_STARTED);
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_ASSOCIATING) ==
           NETWORK_EVENT_CONNECTING);
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_ASSOCIATED) ==
           NETWORK_EVENT_CONNECTING);
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_ADDRESS_READY) ==
           NETWORK_EVENT_ONLINE);
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_ADDRESS_LOST) ==
           NETWORK_EVENT_CONNECTION_LOST);
    assert(wifi_link_get_network_event_type(
               WIFI_PLATFORM_EVENT_AUTHENTICATION_FAILED) ==
           NETWORK_EVENT_FAILED);
    assert(wifi_link_get_network_event_type(
               WIFI_PLATFORM_EVENT_ASSOCIATION_FAILED) == NETWORK_EVENT_FAILED);
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_DRIVER_FAILED) ==
           NETWORK_EVENT_FAILED);
    assert(wifi_link_get_network_event_type(WIFI_PLATFORM_EVENT_STOPPED) ==
