...
enum { MICROSECONDS_PER_MILLISECOND = 1000, SILICON_REVISION_SCALE = 100 };
...
static const char *get_reset_reason_name(esp_reset_reason_t reason)
{
    ...
    case ESP_RST_INT_WDT: return RESET_INTERRUPT_WATCHDOG;
    case ESP_RST_TASK_WDT: return RESET_TASK_WATCHDOG;
...
void platform_get_startup_info(platform_startup_info_t *info)
{
    ...
    *info = (platform_startup_info_t) {
        ...
        .silicon_revision_major =
            (uint32_t)(chip.revision / SILICON_REVISION_SCALE),
        .silicon_revision_minor =
            (uint32_t)(chip.revision % SILICON_REVISION_SCALE),
