# ADR 0004: Flow IL v1 contains a compiler-scheduled instruction stream
...
Transporting graph topology would make each target validate ports, connections,
cycles, and scheduling. Production targets should execute the
...
Flow IL targets load an ordered instruction stream, explicit operands, slot and
